...
class Reach:
    def __init__(
        ...
        self.data_analyst_preprompt = f"""
            ...
            IMPORTANT: Plots must always contain labels or a legend and must be saved.
            ...
            # save the plot or plots to 'web_upload/plots/<plot_name>_<plot_number>.png
            plt.savefig('matplotlib_plot_1.png', bbox_inches='tight')
            fig = plot.get_figure()
            fig.savefig('seaborn_plot_1.png', bbox_inches='tight')
        ...
        self.model_development_preprompt = f"""
            ...
            # save any plots to 'web_upload/plots/<plot_name>_<plot_number>.png
            plt.savefig('matplotlib_plot_1.png', bbox_inches='tight')
            fig = plot.get_figure()
            fig.savefig('seaborn_plot_1.png', bbox_inches='tight')
        ...
        self.so_what_description_preprompt = f"""
            As a data analysis assistant, your task is to interpret the users goal and outputs generated by supplied code.
